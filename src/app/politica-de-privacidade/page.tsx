...
export default function PoliticaPrivacidadePage() {
  return (
    <>
      ...
      <h1 className="text-display mt-4 text-content">Política de Privacidade</h1>
      ...
      <h2 className="text-h2 mt-10 text-content">1. Quem somos</h2>
      <p className="mt-4 leading-relaxed text-content">
      ...
      <h2 className="text-h2 mt-10 text-content">2. Quais dados coletamos e por quê</h2>
      <p className="mt-4 leading-relaxed text-content">
      ...
      <h3 className="mt-8 font-semibold text-content">2.1 Formulário de contato</h3>
      <p className="mt-4 leading-relaxed text-content">
      ...
      <h3 className="mt-8 font-semibold text-content">2.2 Cookies de estatística (Google Analytics 4)</h3>
      <p className="mt-4 leading-relaxed text-content">
      ...
      <h3 className="mt-8 font-semibold text-content">2.3 Diagnóstico CIPA</h3>
      <p className="mt-4 leading-relaxed text-content">
      ...
      <h3 className="mt-8 font-semibold text-content">2.4 Links externos</h3>
      <p className="mt-4 leading-relaxed text-content">
      ...
      <h2 className="text-h2 mt-10 text-content">3. Cookies e como gerenciar seu consentimento</h2>
      <p className="mt-4 leading-relaxed text-content">
      ...
      <h2 className="text-h2 mt-10 text-content">4. Com quem compartilhamos seus dados</h2>
      <p className="mt-4 leading-relaxed text-content">
      ...
      <h2 className="text-h2 mt-10 text-content">5. Por quanto tempo guardamos seus dados</h2>
      <p className="mt-4 leading-relaxed text-content">
      ...
      <h2 className="text-h2 mt-10 text-content">6. Seus direitos como titular</h2>
      <p className="mt-4 leading-relaxed text-content">
      ...
      <h2 className="text-h2 mt-10 text-content">7. Segurança</h2>
      <p className="mt-4 leading-relaxed text-content">
      ...
      <h2 className="text-h2 mt-10 text-content">8. Alterações desta política</h2>
      <p className="mt-4 leading-relaxed text-content">
      ...
      <h2 className="text-h2 mt-10 text-content">9. Legislação aplicável e foro</h2>
      <p className="mt-4 leading-relaxed text-content">
